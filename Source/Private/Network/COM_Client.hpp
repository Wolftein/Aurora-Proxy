...
inline namespace COM
{
    ...
    __interface Network_Client_
    {
        ...
        HRESULT Append([in] BinaryWriter_ * Message);

        HRESULT Flush([in, defaultvalue(0)] Network_Channel Mode);
    ...
    public:
        ...
        // \see Network_Client_::Append
        HRESULT Append(BinaryWriter_ * Message) override;

        // \see Network_Client_::Flush
        HRESULT Flush(Network_Channel Mode);
